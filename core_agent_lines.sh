...
echo "elebot line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "elebot/agent")
core_bus=$(count_top_level_py_lines "elebot/bus")
core_config=$(count_top_level_py_lines "elebot/config")
core_cron=$(count_top_level_py_lines "elebot/cron")
core_heartbeat=$(count_top_level_py_lines "elebot/heartbeat")
core_session=$(count_top_level_py_lines "elebot/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "elebot/agent/tools")
extra_skills=$(count_skill_lines "elebot/skills")
extra_api=$(count_recursive_py_lines "elebot/api")
extra_cli=$(count_recursive_py_lines "elebot/cli")
extra_channels=$(count_recursive_py_lines "elebot/channels")
extra_utils=$(count_recursive_py_lines "elebot/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under elebot/agent"
echo "  - tools/ is counted separately from elebot/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, elebot.py, root files"
