...
def resolve_was_mentioned(payload: dict[str, Any], agent_user_id: str) -> bool:
    """中文说明：resolve_was_mentioned。

    参数:
        payload: 待补充参数说明。
        agent_user_id: 待补充参数说明。
