...
from elebot.utils.helpers import safe_filename, split_message
...
MAX_ATTACHMENT_BYTES = 20 * 1024 * 1024  # 中文说明：20MB
MAX_MESSAGE_LEN = 2000  # 中文说明：Discord message character limit
TYPING_INTERVAL_S = 8
    ...
    class DiscordBotClient(discord.Client):
        ...
        def _register_app_commands(self) -> None:
            ...
            for name, description, command_text in commands:
                ...
                async def command_handler(
                    ...
                    """中文说明：command_handler。

                    参数:
                        interaction: 待补充参数说明。
                        _command_text: 待补充参数说明。
        ...
        async def send_outbound(self, msg: OutboundMessage) -> None:
            ...
            返回:
                待补充返回值说明。
            """
            """Send a elebot outbound message using Discord transport rules."""
...
class DiscordChannel(BaseChannel):
    ...
    def __init__(self, config: Any, bus: MessageBus):
        ...
        self._pending_reactions: dict[str, Any] = {}  # 中文说明：chat_id -> message object
    ...
    async def start(self) -> None:
        ...
        if not DISCORD_AVAILABLE:
            logger.error("discord.py not installed. Run: pip install elebot-ai[discord]")
            return
    ...
    async def _handle_discord_message(self, message: discord.Message) -> None:
        ...
        # 中文说明：Add read receipt reaction immediately, working emoji after delay
        channel_id = self._channel_key(message.channel)
        try:
        ...
        # 中文说明：Delayed working indicator (cosmetic — not tied to subagent lifecycle)
    ...
    async def _clear_reactions(self, chat_id: str) -> None:
        ...
        # 中文说明：Cancel delayed working emoji if it hasn't fired yet
