...
class WebSocketConfig(Base):
    ...
    - ``token_issue_path``: If non-empty, **GET** (HTTP/1.1) to this path returns JSON
      ...
      elebot and shares the asyncio loop, use a thread or async HTTP client for GET—do not call
    ...
    def path_must_start_with_slash(cls, value: str) -> str:
        """中文说明：path_must_start_with_slash。
    ...
    def token_issue_path_differs_from_ws_path(self) -> Self:
        """中文说明：token_issue_path_differs_from_ws_path。
...
def _issue_route_secret_matches(headers: Any, configured_secret: str) -> bool:
    ...
    header_token = headers.get("X-Nanobot-Auth") or headers.get("x-elebot-auth")
    if not header_token:
        return False
...
class WebSocketChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        async def process_request(
            ...
            # 中文说明：Early reject before WebSocket upgrade to avoid unnecessary overhead;
            # 中文说明：_handle_message() performs a second check as defense-in-depth.
    ...
    async def _connection_loop(self, connection: Any) -> None:
        ...
        try:
            ...
            # 中文说明：Register only after ready is successfully sent to avoid out-of-order sends
