...
This directory contains built-in skills that extend elebot's capabilities.
...
When skills reference large local documentation or logs, prefer elebot's built-in
